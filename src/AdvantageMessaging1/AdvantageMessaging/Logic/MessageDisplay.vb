...
#Region " properties "
        ''' <summary>
        ''' The unique Message and Employee Id.
        ''' </summary>
        Private ReadOnly _messageEmployeeId As Guid = Guid.Empty
        Public ReadOnly Property MessageEmployeeId As Guid Implements IMessageDisplay.MessageEmployeeId
            Get
                Return _messageEmployeeId
            End Get
        End Property
        ...
        Public ReadOnly Property MessageId As Guid Implements IMessageDisplay.MessageId, IMessageDisplayState.MessageId
            Get
                Return _messageId
            End Get
        End Property
...
#Region " ctor "
        ...
        ''' </summary>
        ''' <param name="messageEmployeeId">The unique key for this record.</param>
        ''' <param name="messageScheduleId">The MessageScheduleId.</param>
        ''' <param name="messageId">The Message Id.</param>
        ''' <param name="subject">The subject of the message.</param>
        ''' <param name="body">The body of the message.</param>
        ''' <param name="received">The timestamp that the message was received by the local system.</param>
        ''' <remarks></remarks>
        Public Sub New(messageEmployeeId As Guid, messageScheduleId As Guid, messageId As Guid, subject As String, body As String, received As DateTime, isRead As Boolean, isViewed As Boolean)
            ...
            _messageEmployeeId = messageEmployeeId
...
#Region " factory "
        ...
        Public Shared Function CreateFromModel(model As MessageEmployeeModel) As MessageDisplay
            If (model Is Nothing) Then
                Throw New ArgumentNullException("model")
            End If

            Return New MessageDisplay(model.MessageEmployeeId, model.MessageScheduleId, model.MessageSchedule.MessageId, model.MessageSchedule.Message.Subject, model.MessageSchedule.Message.Body, model.MessageSchedule.Received, model.IsRead, model.Viewed.HasValue)
        End Function
